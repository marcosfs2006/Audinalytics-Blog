...
Statement Audits_** de autoria de Trevor R. Stewart, um dos seis artigos que
integram o livro [**Audit Analytics and Continuous Audit: Looking Towards the Future**](https://www.aicpa.org/interestareas/frc/assuranceadvisoryservices/downloadabledocuments/auditanalytics_lookingtowardfuture.pdf), disponível  para _download_ gratuitamente. 
...
Vamos ilustrar o exemplo denominado **Simple DA Visualization** 
...
Modernamente essas técnicas podem ser ampliadas para incluir também as 
